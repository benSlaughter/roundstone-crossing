...
- 361 automated tests, all passing (~4s)
...
| `tests/` | 361 tests across inferrer, tracker, feed, API, history, RTT, models, route_monitor, security headers |
...
python -m pytest tests/ -v         # run test suite (361 tests, ~4s)
```
